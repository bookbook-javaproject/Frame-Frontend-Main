<template>
  <common-main v-bind:style="backgrondStyle">
    ...
    <main>
      <img :class="hasPosts && currentPage === 1 ? 'hidden': ''" v-bind:src="prevButton" alt="이전버튼" @click="goPrevPage" />
      ...
      <img :class="'next' + (hasPosts && currentPage === posts.length ? ' hidden' : '') " v-bind:src="prevButton" alt="다음버튼" @click="goNextPage" />
    </main>
    <footer />
  </common-main>
</template>
