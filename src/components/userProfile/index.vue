<template>
  <div class="userprofile">
      ...
      <input type="text" class="introduction" placeholder="한 줄 소개">
      <div class="complete">완료</div>
      <div class="returnMain" >메인으로 돌아가기</div>
  </div>
</template>
...
.userprofile .image{
    background-image: url('https://pbs.twimg.com/media/Ef8sDBhUcAAhv_c.jpg');
