  ...
  <div class="Write-container">
    ...
    <div class="Write-footer">
        ...
        <div class="Write-select-list">
          ...
          <div class="Write-edit-button" v-on:click="submit">수정</div>
        </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    submit: function(){
      getClientAccessToken().patch('/post', {
  ...
  computed: mapState(['user', 'post_detail']),
  created() {
    this.GET_POST_DETAIL({ postId: this.$route.params.postId })
  }
